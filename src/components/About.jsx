...
const About = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-16 md:mt-[2%]">
      {/* First Section */}
      <div className="flex flex-col md:flex-col-reverse">
        <div className="md:flex-shrink-0 md:ml-5">
            <h2 className="text-2xl font-bold md:mb-2 mb-4 text-center">About Us</h2>
          <p className="text-lg">
        ...
        <div className="md:flex-shrink-0 md:order-1 mt-8 md:mt-4">
            <img src={houseImage} alt="House" className="w-full h-auto md:w-auto md:ml-[25%] md:mb-10" />
        </div>
      </div>
      {/* Second Section */}
      <div className="flex flex-col md:flex-col-reverse mt-6 md:mt-4">
        ...
        <div className="md:order-2">
            <h2 className="text-2xl font-bold mt-8 md:mt-4 mb-4 md:mb-2 text-center">The Housing Market</h2>
